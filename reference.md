...
client.connections().getConnectionTypeSchema(
    "postgresql",
    ConnectionsGetConnectionTypeSchemaRequest
        .builder()
        .build()
);
```
...
client.connections().getParameterValues(
    "248df4b7-aa70-47b8-a036-33ac447e668d",
    ConnectionsGetParameterValuesRequest
        .builder()
        .build()
);
```
...
client.connections().listSharedConnections(
    "248df4b7-aa70-47b8-a036-33ac447e668d",
    ConnectionsListSharedConnectionsRequest
        .builder()
        .build()
);
```
...
client.schemas().resetPrimaryKeys(
    "248df4b7-aa70-47b8-a036-33ac447e668d",
    "public.users",
    SchemasResetPrimaryKeysRequest
        .builder()
        .build()
);
```
...
**params:** `Optional<Map<String, List<String>>>` 
...
**filters:** `Optional<Map<String, String>>` 
...
**filters:** `Optional<List<BulkFilter2>>` 
...
client.modelSync().targets().getCreateProperty(
    "248df4b7-aa70-47b8-a036-33ac447e668d",
    "property",
    TargetsGetCreatePropertyRequest
        .builder()
        .build()
);
```
...
client.modelSync().executions().getLogUrls(
    "248df4b7-aa70-47b8-a036-33ac447e668d",
    "248df4b7-aa70-47b8-a036-33ac447e668d",
    V2ExecutionLogType.RECORDS,
    ExecutionsGetLogUrlsRequest
        .builder()
        .build()
);
```
