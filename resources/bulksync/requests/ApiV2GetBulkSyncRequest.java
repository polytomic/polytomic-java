...
@JsonDeserialize(
    builder = ApiV2GetBulkSyncRequest.Builder.class
)
public final class ApiV2GetBulkSyncRequest {
  private final Optional<Boolean> refreshSchemas;

  private final Map<String, Object> additionalProperties;

  private ApiV2GetBulkSyncRequest(Optional<Boolean> refreshSchemas,
  ...
  public boolean equals(Object other) {
    ...
    return other instanceof ApiV2GetBulkSyncRequest && equalTo((ApiV2GetBulkSyncRequest) other);
  }
  ...
  private boolean equalTo(ApiV2GetBulkSyncRequest other) {
  ...
  public static final class Builder {
    ...
    public Builder from(ApiV2GetBulkSyncRequest other) {
    ...
    public ApiV2GetBulkSyncRequest build() {
      return new ApiV2GetBulkSyncRequest(refreshSchemas, additionalProperties);
    }
  }
}
