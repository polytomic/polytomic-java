...
@JsonDeserialize(
    builder = ApiV2RemoveBulkSyncRequest.Builder.class
)
public final class ApiV2RemoveBulkSyncRequest {
  private final Optional<Boolean> refreshSchemas;

  private final Map<String, Object> additionalProperties;

  private ApiV2RemoveBulkSyncRequest(Optional<Boolean> refreshSchemas,
  ...
  public boolean equals(Object other) {
    ...
    return other instanceof ApiV2RemoveBulkSyncRequest && equalTo((ApiV2RemoveBulkSyncRequest) other);
  }
  ...
  private boolean equalTo(ApiV2RemoveBulkSyncRequest other) {
  ...
  public static final class Builder {
    ...
    public Builder from(ApiV2RemoveBulkSyncRequest other) {
    ...
    public ApiV2RemoveBulkSyncRequest build() {
      return new ApiV2RemoveBulkSyncRequest(refreshSchemas, additionalProperties);
    }
  }
}
