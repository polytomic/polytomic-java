...
@JsonDeserialize(
    builder = ApiV2GetEventsRequest.Builder.class
)
public final class ApiV2GetEventsRequest {
  ...
  private ApiV2GetEventsRequest(Optional<String> organizationId, Optional<String> type,
  ...
  public boolean equals(Object other) {
    ...
    return other instanceof ApiV2GetEventsRequest && equalTo((ApiV2GetEventsRequest) other);
  }
  ...
  private boolean equalTo(ApiV2GetEventsRequest other) {
  ...
  public static final class Builder {
    ...
    public Builder from(ApiV2GetEventsRequest other) {
    ...
    public ApiV2GetEventsRequest build() {
      return new ApiV2GetEventsRequest(organizationId, type, startingAfter, endingBefore, limit, additionalProperties);
    }
  }
}
