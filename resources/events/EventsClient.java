...
import resources.events.requests.ApiV2GetEventsRequest;
import types.V2EventTypesEnvelope;
import types.V2EventsEnvelope;
...
public class EventsClient {
  ...
  public V2EventsEnvelope apiV2GetEvents() {
    return apiV2GetEvents(ApiV2GetEventsRequest.builder().build());
  }

  public V2EventsEnvelope apiV2GetEvents(ApiV2GetEventsRequest request,
