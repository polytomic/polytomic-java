...
@JsonDeserialize(builder = V2BulkSyncDest.Builder.class)
public final class V2BulkSyncDest {
    ...
    private V2BulkSyncDest(
            Optional<Map<String, Optional<V2DestMeta>>> configuration,
            Optional<List<V2SupportedMode>> modes,
