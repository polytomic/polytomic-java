...
@JsonDeserialize(builder = V2BulkSyncDestEnvelope.Builder.class)
public final class V2BulkSyncDestEnvelope {
    private final Optional<V2BulkSyncDest> data;

    private final Map<String, Object> additionalProperties;

    private V2BulkSyncDestEnvelope(Optional<V2BulkSyncDest> data, Map<String, Object> additionalProperties) {
        this.data = data;
