...
public final class V2Mode {
  ...
  private V2Mode(Optional<String> description, Optional<String> label, Optional<String> mode,
  ...
  private boolean equalTo(V2Mode other) {
    return description.equals(other.description) && label.equals(other.label) && mode.equals(other.mode) && requiresIdentity.equals(other.requiresIdentity) && supportsFieldSyncMode.equals(other.supportsFieldSyncMode) && supportsTargetFilters.equals(other.supportsTargetFilters);
  }

  @Override
  public int hashCode() {
    return Objects.hash(this.description, this.label, this.mode, this.requiresIdentity, this.supportsFieldSyncMode, this.supportsTargetFilters);
  }
  ...
  public static final class Builder {
    ...
    public V2Mode build() {
      return new V2Mode(description, label, mode, requiresIdentity, supportsFieldSyncMode, supportsTargetFilters, additionalProperties);
    }
  }
}
