...
@JsonDeserialize(
    builder = V2ConnectionType.Builder.class
)
public final class V2ConnectionType {
  ...
  private V2ConnectionType(Optional<Map<String, Object>> envConfig, Optional<String> id,
      Optional<String> name, Optional<Boolean> useOauth, Map<String, Object> additionalProperties) {
  ...
  private boolean equalTo(V2ConnectionType other) {
    return envConfig.equals(other.envConfig) && id.equals(other.id) && name.equals(other.name) && useOauth.equals(other.useOauth);
  }
