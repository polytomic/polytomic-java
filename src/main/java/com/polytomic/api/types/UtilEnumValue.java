...
public final class UtilEnumValue {
    ...
    private UtilEnumValue(Optional<String> label, Optional<String> value, Map<String, Object> additionalProperties) {
        this.label = label;
        this.value = value;
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof UtilEnumValue && equalTo((UtilEnumValue) other);
    }
    ...
    private boolean equalTo(UtilEnumValue other) {
    ...
    public static final class Builder {
        ...
        public Builder from(UtilEnumValue other) {
