...
@JsonDeserialize(
    builder = V2GetExecutionResponseSchema.Builder.class
)
public final class V2GetExecutionResponseSchema {
  ...
  private V2GetExecutionResponseSchema(Optional<OffsetDateTime> completedAt,
      Optional<V2ExecutionCounts> counts, Optional<OffsetDateTime> createdAt,
      Optional<List<String>> errors, Optional<String> id, Optional<OffsetDateTime> startedAt,
      Optional<String> status, Optional<String> type, Map<String, Object> additionalProperties) {
  ...
  private boolean equalTo(V2GetExecutionResponseSchema other) {
    return completedAt.equals(other.completedAt) && counts.equals(other.counts) && createdAt.equals(other.createdAt) && errors.equals(other.errors) && id.equals(other.id) && startedAt.equals(other.startedAt) && status.equals(other.status) && type.equals(other.type);
  }

  @Override
  public int hashCode() {
    return Objects.hash(this.completedAt, this.counts, this.createdAt, this.errors, this.id, this.startedAt, this.status, this.type);
  }
  ...
  public static final class Builder {
    ...
    public V2GetExecutionResponseSchema build() {
      return new V2GetExecutionResponseSchema(completedAt, counts, createdAt, errors, id, startedAt, status, type, additionalProperties);
    }
  }
}
