...
@JsonDeserialize(
    builder = V2Schedule.Builder.class
)
public final class V2Schedule {
  ...
  private V2Schedule(Optional<String> dayOfMonth, Optional<String> dayOfWeek,
      Optional<String> frequency, Optional<String> hour, Optional<String> minute,
      Optional<String> month, Optional<V2RunAfter> runAfter,
  ...
  private boolean equalTo(V2Schedule other) {
    return dayOfMonth.equals(other.dayOfMonth) && dayOfWeek.equals(other.dayOfWeek) && frequency.equals(other.frequency) && hour.equals(other.hour) && minute.equals(other.minute) && month.equals(other.month) && runAfter.equals(other.runAfter);
  }

  @Override
  public int hashCode() {
    return Objects.hash(this.dayOfMonth, this.dayOfWeek, this.frequency, this.hour, this.minute, this.month, this.runAfter);
  }
  ...
  public static final class Builder {
    ...
    public V2Schedule build() {
      return new V2Schedule(dayOfMonth, dayOfWeek, frequency, hour, minute, month, runAfter, additionalProperties);
    }
  }
}
