...
public final class V2Event {
  ...
  private V2Event(Optional<OffsetDateTime> createdAt, Optional<Object> event, Optional<String> id,
      Optional<String> organizationId, Optional<String> type,
  ...
  private boolean equalTo(V2Event other) {
    return createdAt.equals(other.createdAt) && event.equals(other.event) && id.equals(other.id) && organizationId.equals(other.organizationId) && type.equals(other.type);
  }
