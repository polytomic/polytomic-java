...
@JsonDeserialize(
    builder = V2ConnectionMetaResponse.Builder.class
)
public final class V2ConnectionMetaResponse {
  ...
  private V2ConnectionMetaResponse(Optional<Map<String, V2ConfigurationValue>> configuration,
      Optional<Map<String, Optional<V2ConnectionMeta>>> items, Optional<List<String>> requiresOneOf,
  ...
  private boolean equalTo(V2ConnectionMetaResponse other) {
    return configuration.equals(other.configuration) && items.equals(other.items) && requiresOneOf.equals(other.requiresOneOf);
  }
