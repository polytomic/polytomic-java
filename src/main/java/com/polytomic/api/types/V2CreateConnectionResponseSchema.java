...
@JsonDeserialize(
    builder = V2CreateConnectionResponseSchema.Builder.class
)
public final class V2CreateConnectionResponseSchema {
  ...
  private V2CreateConnectionResponseSchema(Optional<String> authCode, Optional<String> authUrl,
      Optional<Map<String, Object>> configuration, Optional<String> id, Optional<String> name,
      Optional<String> organizationId, Optional<List<String>> policies, Optional<String> status,
      Optional<String> statusError, Optional<V2ConnectionTypeSchema> type,
  ...
  private boolean equalTo(V2CreateConnectionResponseSchema other) {
    return authCode.equals(other.authCode) && authUrl.equals(other.authUrl) && configuration.equals(other.configuration) && id.equals(other.id) && name.equals(other.name) && organizationId.equals(other.organizationId) && policies.equals(other.policies) && status.equals(other.status) && statusError.equals(other.statusError) && type.equals(other.type);
  }

  @Override
  public int hashCode() {
    return Objects.hash(this.authCode, this.authUrl, this.configuration, this.id, this.name, this.organizationId, this.policies, this.status, this.statusError, this.type);
  }
  ...
  public static final class Builder {
    ...
    public V2CreateConnectionResponseSchema build() {
      return new V2CreateConnectionResponseSchema(authCode, authUrl, configuration, id, name, organizationId, policies, status, statusError, type, additionalProperties);
    }
  }
}
