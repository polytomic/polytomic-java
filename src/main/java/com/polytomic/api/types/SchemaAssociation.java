...
@JsonDeserialize(
    builder = SchemaAssociation.Builder.class
)
public final class SchemaAssociation {
  ...
  private SchemaAssociation(Optional<String> id, Optional<String> name,
      Optional<List<String>> referenceTo, Optional<String> referencedField,
  ...
  private boolean equalTo(SchemaAssociation other) {
    return id.equals(other.id) && name.equals(other.name) && referenceTo.equals(other.referenceTo) && referencedField.equals(other.referencedField);
  }
