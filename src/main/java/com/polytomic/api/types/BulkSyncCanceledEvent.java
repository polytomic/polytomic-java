...
@JsonDeserialize(builder = BulkSyncCanceledEvent.Builder.class)
public final class BulkSyncCanceledEvent {
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof BulkSyncCanceledEvent && equalTo((BulkSyncCanceledEvent) other);
    }
    ...
    private boolean equalTo(BulkSyncCanceledEvent other) {
    ...
    public static final class Builder {
        ...
        public Builder from(BulkSyncCanceledEvent other) {
        ...
        public BulkSyncCanceledEvent build() {
            return new BulkSyncCanceledEvent(
