...
@JsonDeserialize(
    builder = SyncDestinationProperties.Builder.class
)
public final class SyncDestinationProperties {
  ...
  private SyncDestinationProperties(Optional<Boolean> doesNotReportOperationCounts,
      Optional<String> newTargetLabel, Optional<Boolean> optionalTargetMappings,
      Optional<String> primaryMetadataObject, Optional<Boolean> requiresConfiguration,
      Optional<Boolean> supportsFieldCreation, Optional<Boolean> supportsFieldTypeSelection,
      Optional<Boolean> supportsTargetFilters, Optional<Boolean> targetCreator,
      Optional<Boolean> useFieldNamesAsLabels, Map<String, Object> additionalProperties) {
  ...
  private boolean equalTo(SyncDestinationProperties other) {
    return doesNotReportOperationCounts.equals(other.doesNotReportOperationCounts) && newTargetLabel.equals(other.newTargetLabel) && optionalTargetMappings.equals(other.optionalTargetMappings) && primaryMetadataObject.equals(other.primaryMetadataObject) && requiresConfiguration.equals(other.requiresConfiguration) && supportsFieldCreation.equals(other.supportsFieldCreation) && supportsFieldTypeSelection.equals(other.supportsFieldTypeSelection) && supportsTargetFilters.equals(other.supportsTargetFilters) && targetCreator.equals(other.targetCreator) && useFieldNamesAsLabels.equals(other.useFieldNamesAsLabels);
  }

  @Override
  public int hashCode() {
    return Objects.hash(this.doesNotReportOperationCounts, this.newTargetLabel, this.optionalTargetMappings, this.primaryMetadataObject, this.requiresConfiguration, this.supportsFieldCreation, this.supportsFieldTypeSelection, this.supportsTargetFilters, this.targetCreator, this.useFieldNamesAsLabels);
  }
  ...
  public static final class Builder {
    ...
    @JsonSetter(
        value = "does_not_report_operation_counts",
        nulls = Nulls.SKIP
    )
    ...
    @JsonSetter(
        value = "optional_target_mappings",
        nulls = Nulls.SKIP
    )
    ...
    @JsonSetter(
        value = "supports_field_type_selection",
        nulls = Nulls.SKIP
    )
    ...
    @JsonSetter(
        value = "use_field_names_as_labels",
        nulls = Nulls.SKIP
    )
    ...
    public SyncDestinationProperties build() {
      return new SyncDestinationProperties(doesNotReportOperationCounts, newTargetLabel, optionalTargetMappings, primaryMetadataObject, requiresConfiguration, supportsFieldCreation, supportsFieldTypeSelection, supportsTargetFilters, targetCreator, useFieldNamesAsLabels, additionalProperties);
    }
  }
}
