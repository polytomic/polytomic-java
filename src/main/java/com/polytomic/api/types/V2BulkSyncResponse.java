...
@JsonDeserialize(
    builder = V2BulkSyncResponse.Builder.class
)
public final class V2BulkSyncResponse {
  ...
  private V2BulkSyncResponse(Optional<Boolean> active,
      Optional<Map<String, Object>> destinationConfiguration,
      Optional<String> destinationConnectionId, Optional<Boolean> discover, Optional<String> id,
      Optional<String> mode, Optional<String> name, Optional<String> organizationId,
      Optional<List<String>> policies, Optional<BulkSchedule> schedule,
      Optional<Map<String, Object>> sourceConfiguration, Optional<String> sourceConnectionId,
  ...
  private boolean equalTo(V2BulkSyncResponse other) {
    return active.equals(other.active) && destinationConfiguration.equals(other.destinationConfiguration) && destinationConnectionId.equals(other.destinationConnectionId) && discover.equals(other.discover) && id.equals(other.id) && mode.equals(other.mode) && name.equals(other.name) && organizationId.equals(other.organizationId) && policies.equals(other.policies) && schedule.equals(other.schedule) && sourceConfiguration.equals(other.sourceConfiguration) && sourceConnectionId.equals(other.sourceConnectionId);
  }

  @Override
  public int hashCode() {
    return Objects.hash(this.active, this.destinationConfiguration, this.destinationConnectionId, this.discover, this.id, this.mode, this.name, this.organizationId, this.policies, this.schedule, this.sourceConfiguration, this.sourceConnectionId);
  }
  ...
  public static final class Builder {
    ...
    public Builder destinationConfiguration(
        Optional<Map<String, Object>> destinationConfiguration) {
      this.destinationConfiguration = destinationConfiguration;
      return this;
    }
    ...
    @JsonSetter(
        value = "destination_connection_id",
        nulls = Nulls.SKIP
    )
    ...
    public V2BulkSyncResponse build() {
      return new V2BulkSyncResponse(active, destinationConfiguration, destinationConnectionId, discover, id, mode, name, organizationId, policies, schedule, sourceConfiguration, sourceConnectionId, additionalProperties);
    }
  }
}
