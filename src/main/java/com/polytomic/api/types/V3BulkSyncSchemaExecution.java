...
@JsonDeserialize(
    builder = V3BulkSyncSchemaExecution.Builder.class
)
public final class V3BulkSyncSchemaExecution {
  ...
  private V3BulkSyncSchemaExecution(Optional<OffsetDateTime> completedAt,
      Optional<Integer> errorCount, Optional<Integer> recordCount, Optional<String> schema,
      Optional<OffsetDateTime> startedAt, Optional<String> status, Optional<String> statusMessage,
  ...
  private boolean equalTo(V3BulkSyncSchemaExecution other) {
    return completedAt.equals(other.completedAt) && errorCount.equals(other.errorCount) && recordCount.equals(other.recordCount) && schema.equals(other.schema) && startedAt.equals(other.startedAt) && status.equals(other.status) && statusMessage.equals(other.statusMessage);
  }

  @Override
  public int hashCode() {
    return Objects.hash(this.completedAt, this.errorCount, this.recordCount, this.schema, this.startedAt, this.status, this.statusMessage);
  }
  ...
  public static final class Builder {
    ...
    public V3BulkSyncSchemaExecution build() {
      return new V3BulkSyncSchemaExecution(completedAt, errorCount, recordCount, schema, startedAt, status, statusMessage, additionalProperties);
    }
  }
}
