...
@JsonDeserialize(builder = V2ConnectionTypeResponseEnvelope.Builder.class)
public final class V2ConnectionTypeResponseEnvelope {
    private final Optional<List<V2ConnectionType>> data;

    private final Map<String, Object> additionalProperties;

    private V2ConnectionTypeResponseEnvelope(
            Optional<List<V2ConnectionType>> data, Map<String, Object> additionalProperties) {
        this.data = data;
