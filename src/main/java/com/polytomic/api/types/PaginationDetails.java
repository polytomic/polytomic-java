...
public final class PaginationDetails {
    ...
    private PaginationDetails(Optional<String> nextPageToken, Map<String, Object> additionalProperties) {
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof PaginationDetails && equalTo((PaginationDetails) other);
    }
    ...
    private boolean equalTo(PaginationDetails other) {
    ...
    public static final class Builder {
        ...
        public Builder from(PaginationDetails other) {
