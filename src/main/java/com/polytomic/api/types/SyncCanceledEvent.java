...
public final class SyncCanceledEvent {
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof SyncCanceledEvent && equalTo((SyncCanceledEvent) other);
    }
    ...
    private boolean equalTo(SyncCanceledEvent other) {
    ...
    public static final class Builder {
        ...
        public Builder from(SyncCanceledEvent other) {
