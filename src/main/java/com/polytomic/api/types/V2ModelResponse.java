...
@JsonDeserialize(
    builder = V2ModelResponse.Builder.class
)
public final class V2ModelResponse {
  ...
  private V2ModelResponse(Optional<Map<String, Object>> configuration,
      Optional<String> connectionId, Optional<List<V2ModelField>> fields, Optional<String> id,
      Optional<String> identifier, Optional<List<Map<String, Object>>> labels,
      Optional<String> name, Optional<String> organizationId, Optional<List<String>> policies,
      Optional<List<V2Relation>> relations, Optional<List<String>> trackingColumns,
      Optional<String> type, Optional<Integer> version, Map<String, Object> additionalProperties) {
  ...
  private boolean equalTo(V2ModelResponse other) {
    return configuration.equals(other.configuration) && connectionId.equals(other.connectionId) && fields.equals(other.fields) && id.equals(other.id) && identifier.equals(other.identifier) && labels.equals(other.labels) && name.equals(other.name) && organizationId.equals(other.organizationId) && policies.equals(other.policies) && relations.equals(other.relations) && trackingColumns.equals(other.trackingColumns) && type.equals(other.type) && version.equals(other.version);
  }

  @Override
  public int hashCode() {
    return Objects.hash(this.configuration, this.connectionId, this.fields, this.id, this.identifier, this.labels, this.name, this.organizationId, this.policies, this.relations, this.trackingColumns, this.type, this.version);
  }
  ...
  public static final class Builder {
    ...
    public V2ModelResponse build() {
      return new V2ModelResponse(configuration, connectionId, fields, id, identifier, labels, name, organizationId, policies, relations, trackingColumns, type, version, additionalProperties);
    }
  }
}
