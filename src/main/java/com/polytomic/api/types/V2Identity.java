...
@JsonDeserialize(
    builder = V2Identity.Builder.class
)
public final class V2Identity {
  ...
  private V2Identity(String function, Optional<Boolean> newField,
      Optional<String> remoteFieldTypeId, V2Source source, String target,
  ...
  private boolean equalTo(V2Identity other) {
    return function.equals(other.function) && newField.equals(other.newField) && remoteFieldTypeId.equals(other.remoteFieldTypeId) && source.equals(other.source) && target.equals(other.target);
  }
