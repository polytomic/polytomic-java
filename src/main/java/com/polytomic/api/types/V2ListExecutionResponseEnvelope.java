...
@JsonDeserialize(builder = V2ListExecutionResponseEnvelope.Builder.class)
public final class V2ListExecutionResponseEnvelope {
    ...
    private V2ListExecutionResponseEnvelope(
            Optional<List<V2GetExecutionResponseSchema>> data, Map<String, Object> additionalProperties) {
        this.data = data;
