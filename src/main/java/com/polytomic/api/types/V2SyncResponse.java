...
@JsonDeserialize(
    builder = V2SyncResponse.Builder.class
)
public final class V2SyncResponse {
  ...
  private V2SyncResponse(Optional<Boolean> active, Optional<List<V2SyncField>> fields,
      Optional<String> filterLogic, Optional<List<V2Filter>> filters, Optional<String> id,
      Optional<V2Identity> identity, Optional<String> mode, Optional<String> name,
      Optional<String> organizationId, Optional<List<V2SyncField>> overrideFields,
      Optional<List<V2Override>> overrides, Optional<List<String>> policies,
      Optional<V2Schedule> schedule, Optional<Boolean> syncAllRecords, Optional<V2Target> target,
  ...
  private boolean equalTo(V2SyncResponse other) {
    return active.equals(other.active) && fields.equals(other.fields) && filterLogic.equals(other.filterLogic) && filters.equals(other.filters) && id.equals(other.id) && identity.equals(other.identity) && mode.equals(other.mode) && name.equals(other.name) && organizationId.equals(other.organizationId) && overrideFields.equals(other.overrideFields) && overrides.equals(other.overrides) && policies.equals(other.policies) && schedule.equals(other.schedule) && syncAllRecords.equals(other.syncAllRecords) && target.equals(other.target);
  }

  @Override
  public int hashCode() {
    return Objects.hash(this.active, this.fields, this.filterLogic, this.filters, this.id, this.identity, this.mode, this.name, this.organizationId, this.overrideFields, this.overrides, this.policies, this.schedule, this.syncAllRecords, this.target);
  }
  ...
  public static final class Builder {
    ...
    public V2SyncResponse build() {
      return new V2SyncResponse(active, fields, filterLogic, filters, id, identity, mode, name, organizationId, overrideFields, overrides, policies, schedule, syncAllRecords, target, additionalProperties);
    }
  }
}
