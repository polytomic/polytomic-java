...
public final class V2ConnectionParameterValuesResponseEnvelope {
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof V2ConnectionParameterValuesResponseEnvelope
                && equalTo((V2ConnectionParameterValuesResponseEnvelope) other);
    }
    ...
    private boolean equalTo(V2ConnectionParameterValuesResponseEnvelope other) {
    ...
    public static final class Builder {
        ...
        public Builder from(V2ConnectionParameterValuesResponseEnvelope other) {
            data(other.getData());
            return this;
        }
        ...
        public V2ConnectionParameterValuesResponseEnvelope build() {
            return new V2ConnectionParameterValuesResponseEnvelope(data, additionalProperties);
        }
    }
}
