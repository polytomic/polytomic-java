...
@JsonDeserialize(
    builder = V2SyncStatusResponse.Builder.class
)
public final class V2SyncStatusResponse {
  ...
  private V2SyncStatusResponse(Optional<V2GetExecutionResponseSchema> currentExecution,
      Optional<V2GetExecutionResponseSchema> lastExecution,
      Optional<OffsetDateTime> nextExecutionTime, Map<String, Object> additionalProperties) {
