...
public final class V2User {
  ...
  private V2User(Optional<String> email, Optional<String> id, Optional<String> organizationId,
  ...
  private boolean equalTo(V2User other) {
    return email.equals(other.email) && id.equals(other.id) && organizationId.equals(other.organizationId) && role.equals(other.role);
  }
