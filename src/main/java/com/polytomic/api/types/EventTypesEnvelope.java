...
public final class EventTypesEnvelope {
    ...
    private EventTypesEnvelope(Optional<List<String>> data, Map<String, Object> additionalProperties) {
        this.data = data;
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof EventTypesEnvelope && equalTo((EventTypesEnvelope) other);
    }
    ...
    private boolean equalTo(EventTypesEnvelope other) {
    ...
    public static final class Builder {
        ...
        public Builder from(EventTypesEnvelope other) {
            data(other.getData());
            return this;
        }
