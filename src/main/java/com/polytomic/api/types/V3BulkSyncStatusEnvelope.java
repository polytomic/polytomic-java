...
@JsonDeserialize(builder = V3BulkSyncStatusEnvelope.Builder.class)
public final class V3BulkSyncStatusEnvelope {
    private final Optional<V3BulkSyncStatusResponse> data;

    private final Map<String, Object> additionalProperties;

    private V3BulkSyncStatusEnvelope(
            Optional<V3BulkSyncStatusResponse> data, Map<String, Object> additionalProperties) {
        this.data = data;
