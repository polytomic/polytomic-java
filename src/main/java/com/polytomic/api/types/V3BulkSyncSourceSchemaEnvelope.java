...
@JsonDeserialize(builder = V3BulkSyncSourceSchemaEnvelope.Builder.class)
public final class V3BulkSyncSourceSchemaEnvelope {
    private final Optional<V3Schema> data;

    private final Map<String, Object> additionalProperties;

    private V3BulkSyncSourceSchemaEnvelope(Optional<V3Schema> data, Map<String, Object> additionalProperties) {
        this.data = data;
