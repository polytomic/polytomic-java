...
@JsonDeserialize(builder = RunQueryResult.Builder.class)
public final class RunQueryResult {
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof RunQueryResult && equalTo((RunQueryResult) other);
    }
    ...
    private boolean equalTo(RunQueryResult other) {
    ...
    public static final class Builder {
        ...
        public Builder from(RunQueryResult other) {
        ...
        /**
         * <p>Error message if the query failed.</p>
         */
        ...
        public RunQueryResult build() {
            return new RunQueryResult(count, error, expires, fields, id, results, status, additionalProperties);
        }
