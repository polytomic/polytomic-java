...
public final class SchemaRecordsResponseEnvelope {
    ...
    private SchemaRecordsResponseEnvelope(
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof SchemaRecordsResponseEnvelope && equalTo((SchemaRecordsResponseEnvelope) other);
    }
    ...
    private boolean equalTo(SchemaRecordsResponseEnvelope other) {
    ...
    public static final class Builder {
        ...
        public Builder from(SchemaRecordsResponseEnvelope other) {
            data(other.getData());
            return this;
        }
