...
@JsonDeserialize(builder = V2CreateConnectionResponseEnvelope.Builder.class)
public final class V2CreateConnectionResponseEnvelope {
    ...
    private V2CreateConnectionResponseEnvelope(
            Optional<V2CreateConnectionResponseSchema> data, Map<String, Object> additionalProperties) {
        this.data = data;
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof V2CreateConnectionResponseEnvelope
                && equalTo((V2CreateConnectionResponseEnvelope) other);
    }
