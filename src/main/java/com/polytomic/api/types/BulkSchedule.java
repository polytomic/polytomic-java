...
@JsonDeserialize(
    builder = BulkSchedule.Builder.class
)
public final class BulkSchedule {
  ...
  private BulkSchedule(Optional<String> dayOfMonth, Optional<String> dayOfWeek, String frequency,
      Optional<String> hour, Optional<String> minute, Optional<String> month,
  ...
  private boolean equalTo(BulkSchedule other) {
    return dayOfMonth.equals(other.dayOfMonth) && dayOfWeek.equals(other.dayOfWeek) && frequency.equals(other.frequency) && hour.equals(other.hour) && minute.equals(other.minute) && month.equals(other.month);
  }
