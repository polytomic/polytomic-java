...
@JsonDeserialize(builder = V2OrganizationsEnvelope.Builder.class)
public final class V2OrganizationsEnvelope {
    private final Optional<List<V2Organization>> data;

    private final Map<String, Object> additionalProperties;

    private V2OrganizationsEnvelope(Optional<List<V2Organization>> data, Map<String, Object> additionalProperties) {
        this.data = data;
