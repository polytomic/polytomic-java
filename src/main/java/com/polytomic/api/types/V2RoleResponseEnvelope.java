...
@JsonDeserialize(builder = V2RoleResponseEnvelope.Builder.class)
public final class V2RoleResponseEnvelope {
    private final Optional<V2RoleResponse> data;

    private final Map<String, Object> additionalProperties;

    private V2RoleResponseEnvelope(Optional<V2RoleResponse> data, Map<String, Object> additionalProperties) {
        this.data = data;
