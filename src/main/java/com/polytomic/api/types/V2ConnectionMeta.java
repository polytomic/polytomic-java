...
@JsonDeserialize(
    builder = V2ConnectionMeta.Builder.class
)
public final class V2ConnectionMeta {
  ...
  private V2ConnectionMeta(Optional<Boolean> hasItems, Optional<List<Object>> items,
      Optional<List<String>> requiresOneOf, Map<String, Object> additionalProperties) {
  ...
  private boolean equalTo(V2ConnectionMeta other) {
    return hasItems.equals(other.hasItems) && items.equals(other.items) && requiresOneOf.equals(other.requiresOneOf);
  }
