...
@JsonDeserialize(
    builder = V2GetIdentityResponseSchema.Builder.class
)
public final class V2GetIdentityResponseSchema {
  ...
  private V2GetIdentityResponseSchema(Optional<String> email, Optional<String> id,
      Optional<Boolean> isOrganization, Optional<Boolean> isPartner, Optional<Boolean> isSystem,
      Optional<Boolean> isUser, Optional<String> organizationId, Optional<String> organizationName,
      Optional<String> role, Map<String, Object> additionalProperties) {
    this.email = email;
    this.id = id;
  ...
  private boolean equalTo(V2GetIdentityResponseSchema other) {
    return email.equals(other.email) && id.equals(other.id) && isOrganization.equals(other.isOrganization) && isPartner.equals(other.isPartner) && isSystem.equals(other.isSystem) && isUser.equals(other.isUser) && organizationId.equals(other.organizationId) && organizationName.equals(other.organizationName) && role.equals(other.role);
  }

  @Override
  public int hashCode() {
    return Objects.hash(this.email, this.id, this.isOrganization, this.isPartner, this.isSystem, this.isUser, this.organizationId, this.organizationName, this.role);
  }
  ...
  public static final class Builder {
    ...
    public V2GetIdentityResponseSchema build() {
      return new V2GetIdentityResponseSchema(email, id, isOrganization, isPartner, isSystem, isUser, organizationId, organizationName, role, additionalProperties);
    }
  }
}
