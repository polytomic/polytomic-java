...
@JsonDeserialize(
    builder = V2SyncField.Builder.class
)
public final class V2SyncField {
  ...
  private V2SyncField(Optional<Boolean> new_, Optional<String> overrideValue, V2Source source,
      Optional<String> syncMode, String target, Map<String, Object> additionalProperties) {
    this.new_ = new_;
  ...
  private boolean equalTo(V2SyncField other) {
    return new_.equals(other.new_) && overrideValue.equals(other.overrideValue) && source.equals(other.source) && syncMode.equals(other.syncMode) && target.equals(other.target);
  }
