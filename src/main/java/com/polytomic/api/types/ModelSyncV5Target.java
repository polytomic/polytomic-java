...
@JsonDeserialize(builder = ModelSyncV5Target.Builder.class)
public final class ModelSyncV5Target {
    ...
    /**
     * @return Deprecated. Use 'target_filters.logic', which combines the conditions it is grouped with.
     */
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof ModelSyncV5Target && equalTo((ModelSyncV5Target) other);
    }
    ...
    private boolean equalTo(ModelSyncV5Target other) {
    ...
    public interface ConnectionIdStage {
        ...
        Builder from(ModelSyncV5Target other);
    }

    public interface _FinalStage {
        ModelSyncV5Target build();
        ...
        /**
         * <p>Deprecated. Use 'target_filters.logic', which combines the conditions it is grouped with.</p>
         */
    ...
    public static final class Builder implements ConnectionIdStage, _FinalStage {
        ...
        @java.lang.Override
        public Builder from(ModelSyncV5Target other) {
        ...
        @java.lang.Override
        public ModelSyncV5Target build() {
            return new ModelSyncV5Target(
                    configuration,
                    connectionId,
                    create,
                    filterLogic,
