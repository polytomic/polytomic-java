...
@JsonDeserialize(builder = V2ActivateSyncEnvelope.Builder.class)
public final class V2ActivateSyncEnvelope {
    private final Optional<V2ActivateSyncOutput> data;

    private final Map<String, Object> additionalProperties;

    private V2ActivateSyncEnvelope(Optional<V2ActivateSyncOutput> data, Map<String, Object> additionalProperties) {
        this.data = data;
