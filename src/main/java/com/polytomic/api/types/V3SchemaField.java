...
@JsonDeserialize(
    builder = V3SchemaField.Builder.class
)
public final class V3SchemaField {
  ...
  private V3SchemaField(Optional<SchemaAssociation> association, Optional<String> id,
      Optional<String> name, Optional<String> remoteType, Optional<String> type,
      Optional<List<V3PickValue>> values, Map<String, Object> additionalProperties) {
  ...
  private boolean equalTo(V3SchemaField other) {
    return association.equals(other.association) && id.equals(other.id) && name.equals(other.name) && remoteType.equals(other.remoteType) && type.equals(other.type) && values.equals(other.values);
  }
