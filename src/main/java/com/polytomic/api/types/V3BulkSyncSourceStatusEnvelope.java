...
@JsonDeserialize(builder = V3BulkSyncSourceStatusEnvelope.Builder.class)
public final class V3BulkSyncSourceStatusEnvelope {
    private final Optional<V3BulkSyncSourceStatus> data;

    private final Map<String, Object> additionalProperties;

    private V3BulkSyncSourceStatusEnvelope(
            Optional<V3BulkSyncSourceStatus> data, Map<String, Object> additionalProperties) {
        this.data = data;
