...
@JsonDeserialize(
    builder = V2ModelField.Builder.class
)
public final class V2ModelField {
  ...
  private V2ModelField(Optional<String> description, Optional<Object> example,
      Optional<String> label, Optional<String> name, Optional<String> remoteType,
      Optional<String> type, Optional<Boolean> unique, Optional<Boolean> userAdded,
  ...
  private boolean equalTo(V2ModelField other) {
    return description.equals(other.description) && example.equals(other.example) && label.equals(other.label) && name.equals(other.name) && remoteType.equals(other.remoteType) && type.equals(other.type) && unique.equals(other.unique) && userAdded.equals(other.userAdded);
  }

  @Override
  public int hashCode() {
    return Objects.hash(this.description, this.example, this.label, this.name, this.remoteType, this.type, this.unique, this.userAdded);
  }
  ...
  public static final class Builder {
    ...
    public V2ModelField build() {
      return new V2ModelField(description, example, label, name, remoteType, type, unique, userAdded, additionalProperties);
    }
  }
}
