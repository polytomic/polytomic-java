...
@JsonDeserialize(
    builder = V2SupportedMode.Builder.class
)
public final class V2SupportedMode {
  ...
  private V2SupportedMode(Optional<String> description, Optional<String> id, Optional<String> label,
      Optional<Boolean> requiresIdentity, Optional<Boolean> supportsFieldSyncMode,
      Optional<Boolean> supportsTargetFilters, Map<String, Object> additionalProperties) {
  ...
  private boolean equalTo(V2SupportedMode other) {
    return description.equals(other.description) && id.equals(other.id) && label.equals(other.label) && requiresIdentity.equals(other.requiresIdentity) && supportsFieldSyncMode.equals(other.supportsFieldSyncMode) && supportsTargetFilters.equals(other.supportsTargetFilters);
  }

  @Override
  public int hashCode() {
    return Objects.hash(this.description, this.id, this.label, this.requiresIdentity, this.supportsFieldSyncMode, this.supportsTargetFilters);
  }
  ...
  public static final class Builder {
    ...
    @JsonSetter(
        value = "supports_field_sync_mode",
        nulls = Nulls.SKIP
    )
    ...
    public V2SupportedMode build() {
      return new V2SupportedMode(description, id, label, requiresIdentity, supportsFieldSyncMode, supportsTargetFilters, additionalProperties);
    }
  }
}
