...
public final class BulkSyncSource {
    ...
    private Optional<List<Schema>> _getSchemas() {
        return schemas;
    }
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof BulkSyncSource && equalTo((BulkSyncSource) other);
    }
    ...
    public static final class Builder {
        ...
        public Builder schemas(Optional<List<Schema>> schemas) {
            this.schemas = schemas;
            return this;
        }
        ...
        public Builder schemas(Nullable<List<Schema>> schemas) {
            if (schemas.isNull()) {
                this.schemas = null;
