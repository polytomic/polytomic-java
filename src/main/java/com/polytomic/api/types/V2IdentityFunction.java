...
@JsonDeserialize(builder = V2IdentityFunction.Builder.class)
public final class V2IdentityFunction {
    ...
    private V2IdentityFunction(Optional<String> id, Optional<String> label, Map<String, Object> additionalProperties) {
        this.id = id;
        this.label = label;
