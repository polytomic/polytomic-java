...
public final class SyncStatusResponse {
    ...
    private final Optional<GetExecutionResponseSchema> lastExecution;
    ...
    private SyncStatusResponse(
            Optional<GetExecutionResponseSchema> currentExecution,
            Optional<GetExecutionResponseSchema> lastExecution,
    ...
    public Optional<GetExecutionResponseSchema> getCurrentExecution() {
        return currentExecution;
    }

    @JsonProperty("last_execution")
    public Optional<GetExecutionResponseSchema> getLastExecution() {
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof SyncStatusResponse && equalTo((SyncStatusResponse) other);
    }
    ...
    private boolean equalTo(SyncStatusResponse other) {
    ...
    public static final class Builder {
        private Optional<GetExecutionResponseSchema> currentExecution = Optional.empty();

        private Optional<GetExecutionResponseSchema> lastExecution = Optional.empty();
        ...
        public Builder from(SyncStatusResponse other) {
        ...
        public Builder currentExecution(Optional<GetExecutionResponseSchema> currentExecution) {
            this.currentExecution = currentExecution;
            return this;
        }
        ...
        public Builder lastExecution(Optional<GetExecutionResponseSchema> lastExecution) {
            this.lastExecution = lastExecution;
            return this;
        }
