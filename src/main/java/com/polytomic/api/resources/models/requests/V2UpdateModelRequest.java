...
@JsonDeserialize(
    builder = V2UpdateModelRequest.Builder.class
)
public final class V2UpdateModelRequest {
  ...
  private V2UpdateModelRequest(Optional<List<V2ModelFieldRequest>> additionalFields,
  ...
  public static final class Builder implements ConnectionIdStage, NameStage, _FinalStage {
    ...
    public V2UpdateModelRequest build() {
      return new V2UpdateModelRequest(additionalFields, configuration, connectionId, fields, identifier, labels, name, organizationId, policies, relations, trackingColumns, additionalProperties);
    }
  }
}
