...
public final class ModelsCreateRequest {
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof ModelsCreateRequest && equalTo((ModelsCreateRequest) other);
    }
    ...
    private boolean equalTo(ModelsCreateRequest other) {
    ...
    public static final class Builder implements BodyStage, _FinalStage {
        ...
        @java.lang.Override
        public Builder from(ModelsCreateRequest other) {
