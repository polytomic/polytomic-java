...
public class RawModelsClient {
     ...
     */
    public PolytomicHttpResponse<GetSyncSourceMetaEnvelope> getEnrichmentSource(String id) {
     ...
     * <code>enrichment</code> block when creating or updating a model sync.</p>
     */
    public PolytomicHttpResponse<GetSyncSourceMetaEnvelope> getEnrichmentSource(
     ...
     * expected inputs.</p>
     */
    public PolytomicHttpResponse<GetEnrichmentInputFieldsResponseEnvelope> post(String connectionId) {
     ...
     * expected inputs.</p>
     */
    public PolytomicHttpResponse<GetEnrichmentInputFieldsResponseEnvelope> post(
     ...
     * </blockquote>
     */
    public PolytomicHttpResponse<Void> delete(String id, ModelsDeleteRequest request) {
