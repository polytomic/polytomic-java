...
public final class ModelsSampleRequest {
    ...
    private ModelsSampleRequest(Optional<Boolean> async, Map<String, Object> additionalProperties) {
        this.async = async;
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof ModelsSampleRequest && equalTo((ModelsSampleRequest) other);
    }
    ...
    private boolean equalTo(ModelsSampleRequest other) {
    ...
    public static final class Builder {
        ...
        public Builder from(ModelsSampleRequest other) {
