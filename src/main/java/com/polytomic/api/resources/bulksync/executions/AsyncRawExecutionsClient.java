...
public class AsyncRawExecutionsClient {
    ...
    public CompletableFuture<PolytomicHttpResponse<BulkSyncExecutionEnvelope>> get(
        ...
        return get(id, execId, ExecutionsGetRequest.builder().build(), requestOptions);
    }

    public CompletableFuture<PolytomicHttpResponse<BulkSyncExecutionEnvelope>> get(
            String id, String execId, ExecutionsGetRequest request) {
    ...
    public CompletableFuture<PolytomicHttpResponse<CancelBulkSyncResponseEnvelope>> cancel(String id, String execId) {
        return cancel(id, execId, ExecutionsCancelRequest.builder().build());
    }

    public CompletableFuture<PolytomicHttpResponse<CancelBulkSyncResponseEnvelope>> cancel(
            String id, String execId, RequestOptions requestOptions) {
        return cancel(id, execId, ExecutionsCancelRequest.builder().build(), requestOptions);
    }

    public CompletableFuture<PolytomicHttpResponse<CancelBulkSyncResponseEnvelope>> cancel(
            String id, String execId, ExecutionsCancelRequest request) {
        return cancel(id, execId, request, null);
    }
    ...
    public CompletableFuture<PolytomicHttpResponse<V4BulkSyncExecutionLogsEnvelope>> getLogs(
        ...
        return getLogs(syncId, executionId, ExecutionsGetLogsRequest.builder().build(), requestOptions);
    }
