...
@JsonDeserialize(
    builder = V2UpdateBulkSyncRequest.Builder.class
)
public final class V2UpdateBulkSyncRequest {
  ...
  private V2UpdateBulkSyncRequest(Optional<Boolean> active,
      ...
      Optional<List<String>> policies, BulkSchedule schedule,
  ...
  private boolean equalTo(V2UpdateBulkSyncRequest other) {
    return active.equals(other.active) && destinationConfiguration.equals(other.destinationConfiguration) && destinationConnectionId.equals(other.destinationConnectionId) && discover.equals(other.discover) && mode.equals(other.mode) && name.equals(other.name) && organizationId.equals(other.organizationId) && policies.equals(other.policies) && schedule.equals(other.schedule) && sourceConfiguration.equals(other.sourceConfiguration) && sourceConnectionId.equals(other.sourceConnectionId);
  }

  @Override
  public int hashCode() {
    return Objects.hash(this.active, this.destinationConfiguration, this.destinationConnectionId, this.discover, this.mode, this.name, this.organizationId, this.policies, this.schedule, this.sourceConfiguration, this.sourceConnectionId);
  }
  ...
  public static final class Builder implements DestinationConnectionIdStage, ModeStage, NameStage, ScheduleStage, SourceConnectionIdStage, _FinalStage {
    ...
    public V2UpdateBulkSyncRequest build() {
      return new V2UpdateBulkSyncRequest(active, destinationConfiguration, destinationConnectionId, discover, mode, name, organizationId, policies, schedule, sourceConfiguration, sourceConnectionId, additionalProperties);
    }
  }
}
