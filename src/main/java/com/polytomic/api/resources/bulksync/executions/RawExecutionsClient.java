...
public class RawExecutionsClient {
     ...
     */
    public PolytomicHttpResponse<ListBulkSyncExecutionsStatusEnvelope> listStatus() {
     ...
     * expands the request to the caller's organization scope.</p>
     */
    public PolytomicHttpResponse<ListBulkSyncExecutionsStatusEnvelope> listStatus(RequestOptions requestOptions) {
     ...
     * expands the request to the caller's organization scope.</p>
     */
    public PolytomicHttpResponse<ListBulkSyncExecutionsStatusEnvelope> listStatus(ExecutionsListStatusRequest request) {
     ...
     * </blockquote>
     */
    public PolytomicHttpResponse<BulkSyncExecutionLogsEnvelope> getLogs(String syncId, String executionId) {
     ...
     * </blockquote>
     */
    public PolytomicHttpResponse<BulkSyncExecutionLogsEnvelope> getLogs(
            String syncId, String executionId, RequestOptions requestOptions) {
        HttpUrl.Builder httpUrl = HttpUrl.parse(this.clientOptions.environment().getUrl())
                .newBuilder()
                .addPathSegments("api/bulk/syncs")
        ...
        try (Response response = client.newCall(okhttpRequest).execute()) {
            ...
            if (response.isSuccessful()) {
                return new PolytomicHttpResponse<>(
                        ObjectMappers.JSON_MAPPER.readValue(responseBodyString, BulkSyncExecutionLogsEnvelope.class),
                        response);
            }
            try {
                if (response.code() == 404) {
     ...
     * </blockquote>
     */
    public PolytomicHttpResponse<ExportSyncLogsEnvelope> exportLogs(String syncId, String executionId) {
        return exportLogs(
     ...
     * </blockquote>
     */
    public PolytomicHttpResponse<ExportSyncLogsEnvelope> exportLogs(
     ...
     */
    public PolytomicHttpResponse<ExecutionConsoleLogsResponseEnvelope> getSchemaConsoleLogs(
     ...
     */
    public PolytomicHttpResponse<ExecutionConsoleLogsResponseEnvelope> getIngestConsoleLogs(String connectionId) {
     ...
     * Fetch the latest console log entries for ingestion scoped by connection and optional bulk sync. Returns the most recent 50 entries.
     */
    public PolytomicHttpResponse<ExecutionConsoleLogsResponseEnvelope> getIngestConsoleLogs(
