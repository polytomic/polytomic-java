...
public class RawSchemasClient {
     ...
     */
    public PolytomicHttpResponse<ListBulkSchemaEnvelope> list(String id) {
     ...
     * <a href="../../../../../api-reference/bulk-sync/schemas/update"><code>PUT /api/bulk/syncs/{id}/schemas/{schema_id}</code></a>.</p>
     */
    public PolytomicHttpResponse<ListBulkSchemaEnvelope> list(String id, RequestOptions requestOptions) {
     ...
     * <a href="../../../../../api-reference/bulk-sync/schemas/update"><code>PUT /api/bulk/syncs/{id}/schemas/{schema_id}</code></a>.</p>
     */
    public PolytomicHttpResponse<ListBulkSchemaEnvelope> list(String id, SchemasListRequest request) {
     ...
     * <a href="../../../../../api-reference/bulk-sync/schemas/update"><code>PUT /api/bulk/syncs/{id}/schemas/{schema_id}</code></a>.</p>
     */
    public PolytomicHttpResponse<ListBulkSchemaEnvelope> list(
     ...
     * </blockquote>
     */
    public PolytomicHttpResponse<UpdateBulkSyncSchemasEnvelope> patch(String id) {
     ...
     * </blockquote>
     */
    public PolytomicHttpResponse<UpdateBulkSyncSchemasEnvelope> patch(
     ...
     * </blockquote>
     */
    public PolytomicHttpResponse<UpdateBulkSyncSchemasEnvelope> patch(String id, UpdateBulkSyncSchemasRequest request) {
    ...
    public PolytomicHttpResponse<UpdateBulkSyncSchemasEnvelope> patch(
        ...
        try (Response response = client.newCall(okhttpRequest).execute()) {
            ...
            if (response.isSuccessful()) {
                return new PolytomicHttpResponse<>(
                        ObjectMappers.JSON_MAPPER.readValue(responseBodyString, UpdateBulkSyncSchemasEnvelope.class),
                        response);
            }
            try {
