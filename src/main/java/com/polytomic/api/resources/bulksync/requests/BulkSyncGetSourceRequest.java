...
public final class BulkSyncGetSourceRequest {
    ...
    private BulkSyncGetSourceRequest(Optional<Boolean> refreshSchemas, Map<String, Object> additionalProperties) {
    ...
    public static final class Builder {
        ...
        public BulkSyncGetSourceRequest build() {
            return new BulkSyncGetSourceRequest(refreshSchemas, additionalProperties);
        }
    }
}
