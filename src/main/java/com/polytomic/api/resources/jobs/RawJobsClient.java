...
public class RawJobsClient {
    ...
    public PolytomicHttpResponse<JobResponseEnvelope> get(String id, String type) {
        return get(id, type, null);
    }

    public PolytomicHttpResponse<JobResponseEnvelope> get(String id, String type, RequestOptions requestOptions) {
