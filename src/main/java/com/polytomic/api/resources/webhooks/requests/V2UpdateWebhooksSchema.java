...
@JsonDeserialize(
    builder = V2UpdateWebhooksSchema.Builder.class
)
public final class V2UpdateWebhooksSchema {
  ...
  private V2UpdateWebhooksSchema(String endpoint, Optional<String> organizationId, String secret,
  ...
  public boolean equals(Object other) {
    ...
    return other instanceof V2UpdateWebhooksSchema && equalTo((V2UpdateWebhooksSchema) other);
  }
  ...
  private boolean equalTo(V2UpdateWebhooksSchema other) {
  ...
  public interface EndpointStage {
    ...
    Builder from(V2UpdateWebhooksSchema other);
  }
  ...
  public static final class Builder implements EndpointStage, SecretStage, _FinalStage {
    ...
    @Override
    public Builder from(V2UpdateWebhooksSchema other) {
    ...
    @Override
    public V2UpdateWebhooksSchema build() {
      return new V2UpdateWebhooksSchema(endpoint, organizationId, secret, additionalProperties);
    }
  }
}
