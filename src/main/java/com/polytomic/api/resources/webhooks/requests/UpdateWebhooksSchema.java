...
@JsonDeserialize(builder = UpdateWebhooksSchema.Builder.class)
public final class UpdateWebhooksSchema {
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof UpdateWebhooksSchema && equalTo((UpdateWebhooksSchema) other);
    }
    ...
    private boolean equalTo(UpdateWebhooksSchema other) {
    ...
    public interface EndpointStage {
        ...
        Builder from(UpdateWebhooksSchema other);
    }
    ...
    public static final class Builder implements EndpointStage, SecretStage, _FinalStage {
        ...
        @java.lang.Override
        public Builder from(UpdateWebhooksSchema other) {
        ...
        @java.lang.Override
        public UpdateWebhooksSchema build() {
            return new UpdateWebhooksSchema(endpoint, organizationId, secret, additionalProperties);
        }
    }
}
