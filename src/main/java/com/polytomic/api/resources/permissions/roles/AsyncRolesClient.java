...
public class AsyncRolesClient {
    ...
    public CompletableFuture<RoleResponseEnvelope> get(String id, RolesGetRequest request) {
        return this.rawClient.get(id, request).thenApply(response -> response.body());
    }

    public CompletableFuture<RoleResponseEnvelope> get(
    ...
    public CompletableFuture<Void> remove(String id, RolesRemoveRequest request) {
        return this.rawClient.remove(id, request).thenApply(response -> response.body());
    }

    public CompletableFuture<Void> remove(String id, RolesRemoveRequest request, RequestOptions requestOptions) {
