...
public class RawNotificationsClient {
    ...
    public PolytomicHttpResponse<V4GlobalErrorSubscribersResponse> getGlobalErrorSubscribers() {
        ...
        try (Response response = client.newCall(okhttpRequest).execute()) {
            ...
            if (response.isSuccessful()) {
                return new PolytomicHttpResponse<>(
                        ObjectMappers.JSON_MAPPER.readValue(responseBodyString, V4GlobalErrorSubscribersResponse.class),
                        response);
            }
            try {
    ...
    public PolytomicHttpResponse<V4GlobalErrorSubscribersResponse> setGlobalErrorSubscribers() {
