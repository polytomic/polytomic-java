...
import com.polytomic.api.resources.modelsync.types.V2UpdateSyncRequestMode;
...
@JsonDeserialize(
    builder = V2UpdateSyncRequest.Builder.class
)
public final class V2UpdateSyncRequest {
  ...
  private final V2UpdateSyncRequestMode mode;
  ...
  private V2UpdateSyncRequest(Optional<Boolean> active, Optional<List<V2SyncField>> fields,
      Optional<String> filterLogic, Optional<List<V2Filter>> filters, Optional<V2Identity> identity,
      V2UpdateSyncRequestMode mode, String name, Optional<String> organizationId,
      Optional<List<V2SyncField>> overrideFields, Optional<List<V2Override>> overrides,
      Optional<List<String>> policies, V2Schedule schedule, Optional<Boolean> syncAllRecords,
      V2Target target, Map<String, Object> additionalProperties) {
    this.active = active;
    this.fields = fields;
  ...
  @JsonProperty("mode")
  public V2UpdateSyncRequestMode getMode() {
    return mode;
  }
  ...
  private boolean equalTo(V2UpdateSyncRequest other) {
    return active.equals(other.active) && fields.equals(other.fields) && filterLogic.equals(other.filterLogic) && filters.equals(other.filters) && identity.equals(other.identity) && mode.equals(other.mode) && name.equals(other.name) && organizationId.equals(other.organizationId) && overrideFields.equals(other.overrideFields) && overrides.equals(other.overrides) && policies.equals(other.policies) && schedule.equals(other.schedule) && syncAllRecords.equals(other.syncAllRecords) && target.equals(other.target);
  }

  @Override
  public int hashCode() {
    return Objects.hash(this.active, this.fields, this.filterLogic, this.filters, this.identity, this.mode, this.name, this.organizationId, this.overrideFields, this.overrides, this.policies, this.schedule, this.syncAllRecords, this.target);
  }
  ...
  public interface ModeStage {
    NameStage mode(V2UpdateSyncRequestMode mode);

    Builder from(V2UpdateSyncRequest other);
  }
  ...
  public static final class Builder implements ModeStage, NameStage, ScheduleStage, TargetStage, _FinalStage {
    private V2UpdateSyncRequestMode mode;
    ...
    public V2UpdateSyncRequest build() {
      return new V2UpdateSyncRequest(active, fields, filterLogic, filters, identity, mode, name, organizationId, overrideFields, overrides, policies, schedule, syncAllRecords, target, additionalProperties);
    }
  }
}
