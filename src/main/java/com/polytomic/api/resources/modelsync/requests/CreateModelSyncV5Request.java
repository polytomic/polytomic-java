...
import com.polytomic.api.types.OverrideFieldInput;
import com.polytomic.api.types.Schedule;
import com.polytomic.api.types.SyncField;
import com.polytomic.api.types.TargetFilters;
...
@JsonDeserialize(builder = CreateModelSyncV5Request.Builder.class)
public final class CreateModelSyncV5Request {
    ...
    private final Optional<ModelFilters> modelFilters;
    ...
    private final Optional<List<OverrideFieldInput>> overrideFields;
    ...
    private final ModelSyncV5Target target;

    private final Optional<TargetFilters> targetFilters;

    private final Map<String, Object> additionalProperties;

    private CreateModelSyncV5Request(
            ...
            Optional<List<OverrideFieldInput>> overrideFields,
            ...
            ModelSyncV5Target target,
            Optional<TargetFilters> targetFilters,
    ...
    /**
     * @return Deprecated. Use 'model_filters.logic'. Combines the model filters in 'filters' only.
     */
    ...
    /**
     * @return Deprecated. Use 'model_filters.conditions' and 'target_filters.conditions', which say which kind each condition is rather than inferring it. Ignored when either of those is present, except that a request carrying both shapes is rejected if they describe different filters.
     */
    ...
    @JsonProperty("model_filters")
    public Optional<ModelFilters> getModelFilters() {
        return modelFilters;
    }
    ...
    /**
     * @return Target fields which are set to a fixed value for every record, rather than mapped from a model field.
     */
    @JsonProperty("override_fields")
    public Optional<List<OverrideFieldInput>> getOverrideFields() {
    ...
    @JsonProperty("target")
    public ModelSyncV5Target getTarget() {
        return target;
    }

    @JsonProperty("target_filters")
    public Optional<TargetFilters> getTargetFilters() {
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof CreateModelSyncV5Request && equalTo((CreateModelSyncV5Request) other);
    }
    ...
    private boolean equalTo(CreateModelSyncV5Request other) {
        return active.equals(other.active)
                ...
                && targetFilters.equals(other.targetFilters);
    }
    ...
    public interface ModeStage {
        ...
        Builder from(CreateModelSyncV5Request other);
    }
    ...
    public interface TargetStage {
        _FinalStage target(@NotNull ModelSyncV5Target target);
    }

    public interface _FinalStage {
        CreateModelSyncV5Request build();
        ...
        /**
         * <p>Deprecated. Use 'model_filters.logic'. Combines the model filters in 'filters' only.</p>
         */
        ...
        /**
         * <p>Deprecated. Use 'model_filters.conditions' and 'target_filters.conditions', which say which kind each condition is rather than inferring it. Ignored when either of those is present, except that a request carrying both shapes is rejected if they describe different filters.</p>
         */
        ...
        _FinalStage modelFilters(Optional<ModelFilters> modelFilters);

        _FinalStage modelFilters(ModelFilters modelFilters);
        ...
        /**
         * <p>Target fields which are set to a fixed value for every record, rather than mapped from a model field.</p>
         */
        _FinalStage overrideFields(Optional<List<OverrideFieldInput>> overrideFields);

        _FinalStage overrideFields(List<OverrideFieldInput> overrideFields);
        ...
        _FinalStage targetFilters(Optional<TargetFilters> targetFilters);

        _FinalStage targetFilters(TargetFilters targetFilters);
    }
    ...
    public static final class Builder implements ModeStage, NameStage, ScheduleStage, TargetStage, _FinalStage {
        ...
        private ModelSyncV5Target target;

        private Optional<TargetFilters> targetFilters = Optional.empty();
        ...
        private Optional<List<OverrideFieldInput>> overrideFields = Optional.empty();

        private Optional<String> organizationId = Optional.empty();

        private Optional<Boolean> onlyEnrichUpdates = Optional.empty();

        private Optional<ModelFilters> modelFilters = Optional.empty();
        ...
        @java.lang.Override
        public Builder from(CreateModelSyncV5Request other) {
            ...
            targetFilters(other.getTargetFilters());
            return this;
        }
        ...
        @java.lang.Override
        @JsonSetter("target")
        public _FinalStage target(@NotNull ModelSyncV5Target target) {
            this.target = target;
            return this;
        }

        @java.lang.Override
        public _FinalStage targetFilters(TargetFilters targetFilters) {
            this.targetFilters = Optional.ofNullable(targetFilters);
            return this;
        }

        @java.lang.Override
        @JsonSetter(value = "target_filters", nulls = Nulls.SKIP)
        public _FinalStage targetFilters(Optional<TargetFilters> targetFilters) {
            this.targetFilters = targetFilters;
            return this;
        }
         ...
         */
        @java.lang.Override
        public _FinalStage overrideFields(List<OverrideFieldInput> overrideFields) {
        ...
        public _FinalStage overrideFields(Optional<List<OverrideFieldInput>> overrideFields) {
            this.overrideFields = overrideFields;
            return this;
        }
        ...
        @java.lang.Override
        public _FinalStage modelFilters(ModelFilters modelFilters) {
            this.modelFilters = Optional.ofNullable(modelFilters);
            return this;
        }

        @java.lang.Override
        @JsonSetter(value = "model_filters", nulls = Nulls.SKIP)
        public _FinalStage modelFilters(Optional<ModelFilters> modelFilters) {
            this.modelFilters = modelFilters;
            return this;
        }
        ...
        @java.lang.Override
        public CreateModelSyncV5Request build() {
            return new CreateModelSyncV5Request(
                    active,
