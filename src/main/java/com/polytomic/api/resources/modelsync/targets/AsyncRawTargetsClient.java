...
public class AsyncRawTargetsClient {
     ...
     */
    public CompletableFuture<PolytomicHttpResponse<TargetResponseEnvelope>> getTargetFields(String id) {
     ...
     */
    public CompletableFuture<PolytomicHttpResponse<TargetObjectsResponseEnvelope>> list(String id) {
     ...
     * what operations the mode supports.</p>
     */
    public CompletableFuture<PolytomicHttpResponse<TargetObjectsResponseEnvelope>> list(
            String id, RequestOptions requestOptions) {
    ...
    public CompletableFuture<PolytomicHttpResponse<TargetObjectsResponseEnvelope>> list(
        ...
        CompletableFuture<PolytomicHttpResponse<TargetObjectsResponseEnvelope>> future = new CompletableFuture<>();
        client.newCall(okhttpRequest).enqueue(new Callback() {
            @Override
            public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
                try (ResponseBody responseBody = response.body()) {
                    ...
                    if (response.isSuccessful()) {
                        future.complete(new PolytomicHttpResponse<>(
                                ObjectMappers.JSON_MAPPER.readValue(
                                        responseBodyString, TargetObjectsResponseEnvelope.class),
                                response));
                        return;
                    }
                    try {
     ...
     * sync</a>.</p>
     */
    public CompletableFuture<PolytomicHttpResponse<TargetPropertyValuesEnvelope>> getCreateProperty(
    ...
    public CompletableFuture<PolytomicHttpResponse<TargetPropertyValuesEnvelope>> getCreateProperty(
        ...
        CompletableFuture<PolytomicHttpResponse<TargetPropertyValuesEnvelope>> future = new CompletableFuture<>();
        client.newCall(okhttpRequest).enqueue(new Callback() {
            @Override
            public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
                try (ResponseBody responseBody = response.body()) {
                    ...
                    if (response.isSuccessful()) {
                        future.complete(new PolytomicHttpResponse<>(
                                ObjectMappers.JSON_MAPPER.readValue(
                                        responseBodyString, TargetPropertyValuesEnvelope.class),
                                response));
                        return;
                    }
                    try {
