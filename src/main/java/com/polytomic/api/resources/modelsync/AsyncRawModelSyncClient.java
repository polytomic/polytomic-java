...
public class AsyncRawModelSyncClient {
     ...
     */
    public CompletableFuture<PolytomicHttpResponse<GetSyncSourceMetaEnvelope>> getSource(String id) {
     ...
     * <a href="../../../../../api-reference/model-sync/get-source-fields"><code>GET /api/connections/{id}/modelsync/source/fields</code></a>.</p>
     */
    public CompletableFuture<PolytomicHttpResponse<GetSyncSourceMetaEnvelope>> getSource(
     ...
     */
    public CompletableFuture<PolytomicHttpResponse<ListSyncResponseEnvelope>> list() {
     ...
     * <a href="../../api-reference/model-sync/get"><code>GET /api/syncs/{id}</code></a>.</p>
     */
    public CompletableFuture<PolytomicHttpResponse<ListSyncResponseEnvelope>> list(RequestOptions requestOptions) {
     ...
     * <a href="../../api-reference/model-sync/get"><code>GET /api/syncs/{id}</code></a>.</p>
     */
    public CompletableFuture<PolytomicHttpResponse<ListSyncResponseEnvelope>> list(ModelSyncListRequest request) {
    ...
    public CompletableFuture<PolytomicHttpResponse<ListSyncResponseEnvelope>> list(
        ...
        CompletableFuture<PolytomicHttpResponse<ListSyncResponseEnvelope>> future = new CompletableFuture<>();
        client.newCall(okhttpRequest).enqueue(new Callback() {
            @Override
            public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
                try (ResponseBody responseBody = response.body()) {
     ...
     */
    public CompletableFuture<PolytomicHttpResponse<CancelSyncResponseEnvelope>> cancel(String id) {
     ...
     * cancellation has taken effect.</p>
     */
    public CompletableFuture<PolytomicHttpResponse<CancelSyncResponseEnvelope>> cancel(
        ...
        CompletableFuture<PolytomicHttpResponse<CancelSyncResponseEnvelope>> future = new CompletableFuture<>();
        client.newCall(okhttpRequest).enqueue(new Callback() {
            @Override
            public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
                try (ResponseBody responseBody = response.body()) {
                    ...
                    if (response.isSuccessful()) {
                        future.complete(new PolytomicHttpResponse<>(
                                ObjectMappers.JSON_MAPPER.readValue(
                                        responseBodyString, CancelSyncResponseEnvelope.class),
                                response));
                        return;
                    }
                    try {
    ...
    public CompletableFuture<PolytomicHttpResponse<StartSyncResponseEnvelope>> start(
        ...
        CompletableFuture<PolytomicHttpResponse<StartSyncResponseEnvelope>> future = new CompletableFuture<>();
        client.newCall(okhttpRequest).enqueue(new Callback() {
            @Override
            public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
                try (ResponseBody responseBody = response.body()) {
                    ...
                    if (response.isSuccessful()) {
                        future.complete(new PolytomicHttpResponse<>(
                                ObjectMappers.JSON_MAPPER.readValue(
                                        responseBodyString, StartSyncResponseEnvelope.class),
                                response));
                        return;
                    }
                    try {
