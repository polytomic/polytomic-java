...
@JsonDeserialize(
    builder = V2CreateSyncRequest.Builder.class
)
public final class V2CreateSyncRequest {
  ...
  private V2CreateSyncRequest(Optional<Boolean> active, Optional<List<V2SyncField>> fields,
      Optional<String> filterLogic, Optional<List<V2Filter>> filters, Optional<V2Identity> identity,
      V2CreateSyncRequestMode mode, String name, Optional<String> organizationId,
  ...
  public static final class Builder implements ModeStage, NameStage, ScheduleStage, TargetStage, _FinalStage {
    ...
    public V2CreateSyncRequest build() {
      return new V2CreateSyncRequest(active, fields, filterLogic, filters, identity, mode, name, organizationId, overrideFields, overrides, policies, schedule, syncAllRecords, target, additionalProperties);
    }
  }
}
