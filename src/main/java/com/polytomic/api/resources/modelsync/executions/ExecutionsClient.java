...
public class ExecutionsClient {
     ...
     */
    public LogsIndexResponseEnvelope getLogsIndex(String syncId, String id) {
        return this.rawClient.getLogsIndex(syncId, id).body();
    }

    /**
     * Returns an index of the record-log types produced by this model sync execution, with the per-type endpoint to retrieve signed URLs for each type's segment files.
     */
    public LogsIndexResponseEnvelope getLogsIndex(String syncId, String id, RequestOptions requestOptions) {
        return this.rawClient.getLogsIndex(syncId, id, requestOptions).body();
    }
