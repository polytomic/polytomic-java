...
public class ExecutionsClient {
    ...
    public GetExecutionResponseEnvelope get(String syncId, String id, ExecutionsGetRequest request) {
        return this.rawClient.get(syncId, id, request).body();
    }
    ...
    public GetExecutionResponseEnvelope get(
        ...
        return this.rawClient.get(syncId, id, request, requestOptions).body();
    }
    ...
    public ExecutionLogsResponseEnvelope getLogUrls(
        ...
        return this.rawClient.getLogUrls(syncId, id, type, request).body();
    }
    ...
    public void getLogs(
        ...
        this.rawClient.getLogs(syncId, id, type, filename, request).body();
    }
