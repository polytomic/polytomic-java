...
@JsonDeserialize(builder = CreateSyncRequest.Builder.class)
public final class CreateSyncRequest {
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof CreateSyncRequest && equalTo((CreateSyncRequest) other);
    }
    ...
    private boolean equalTo(CreateSyncRequest other) {
    ...
    public interface ModeStage {
        ...
        Builder from(CreateSyncRequest other);
    }
    ...
    public static final class Builder implements ModeStage, NameStage, ScheduleStage, TargetStage, _FinalStage {
        ...
        @java.lang.Override
        public Builder from(CreateSyncRequest other) {
        ...
        @java.lang.Override
        public CreateSyncRequest build() {
            return new CreateSyncRequest(
                    active,
