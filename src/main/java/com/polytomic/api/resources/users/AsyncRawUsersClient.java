...
public class AsyncRawUsersClient {
    ...
    public CompletableFuture<PolytomicHttpResponse<UserEnvelope>> get(String id, String orgId) {
        return get(id, orgId, null);
    }

    public CompletableFuture<PolytomicHttpResponse<UserEnvelope>> get(
            String id, String orgId, RequestOptions requestOptions) {
        HttpUrl.Builder httpUrl = HttpUrl.parse(this.clientOptions.environment().getUrl())
                .newBuilder()
                .addPathSegments("api/organizations")
                .addPathSegment(orgId)
    ...
    public CompletableFuture<PolytomicHttpResponse<UserEnvelope>> update(
            String id, String orgId, UpdateUserRequestSchema request) {
    ...
    public CompletableFuture<PolytomicHttpResponse<UserEnvelope>> remove(String id, String orgId) {
