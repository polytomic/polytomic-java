...
@JsonDeserialize(builder = V2UpdateUserRequestSchema.Builder.class)
public final class V2UpdateUserRequestSchema {
    ...
    private V2UpdateUserRequestSchema(String email, Optional<String> role, Map<String, Object> additionalProperties) {
        this.email = email;
        this.role = role;
