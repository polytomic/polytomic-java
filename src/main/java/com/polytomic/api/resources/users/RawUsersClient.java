...
public class RawUsersClient {
     ...
     */
    public PolytomicHttpResponse<UserEnvelope> createCurrentOrgUser(CurrentOrgCreateUserRequestSchema request) {
     ...
     * account. Role assignments take effect as soon as the invitation is accepted.</p>
     */
    public PolytomicHttpResponse<UserEnvelope> createCurrentOrgUser(
     ...
     */
    public PolytomicHttpResponse<UserEnvelope> updateCurrentOrgUser(String id) {
     ...
     * and email address is not affected by this endpoint.</p>
     */
    public PolytomicHttpResponse<UserEnvelope> updateCurrentOrgUser(
