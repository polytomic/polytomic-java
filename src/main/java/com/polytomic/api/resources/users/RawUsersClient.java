...
public class RawUsersClient {
    ...
    public PolytomicHttpResponse<ListUsersEnvelope> list(String orgId, UsersListRequest request) {
        return list(orgId, request, null);
    }

    public PolytomicHttpResponse<ListUsersEnvelope> list(
    ...
    public PolytomicHttpResponse<UserEnvelope> get(String orgId, String id) {
        return get(orgId, id, UsersGetRequest.builder().build());
    }

    public PolytomicHttpResponse<UserEnvelope> get(String orgId, String id, RequestOptions requestOptions) {
        return get(orgId, id, UsersGetRequest.builder().build(), requestOptions);
    }

    public PolytomicHttpResponse<UserEnvelope> get(String orgId, String id, UsersGetRequest request) {
        return get(orgId, id, request, null);
    }

    public PolytomicHttpResponse<UserEnvelope> get(
    ...
    public PolytomicHttpResponse<UserEnvelope> update(String orgId, String id, UpdateUserRequestSchema request) {
    ...
    public PolytomicHttpResponse<UserEnvelope> remove(String orgId, String id, RequestOptions requestOptions) {
        return remove(orgId, id, UsersRemoveRequest.builder().build(), requestOptions);
    }

    public PolytomicHttpResponse<UserEnvelope> remove(String orgId, String id, UsersRemoveRequest request) {
