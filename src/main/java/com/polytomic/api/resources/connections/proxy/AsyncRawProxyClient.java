...
public class AsyncRawProxyClient {
     ...
     */
    public CompletableFuture<PolytomicHttpResponse<ConnectionProxySettingsEnvelope>> getProxySettings(String id) {
     ...
     * <code>parentConnectionId</code> is omitted.</p>
     */
    public CompletableFuture<PolytomicHttpResponse<ConnectionProxySettingsEnvelope>> getProxySettings(
            String id, RequestOptions requestOptions) {
        HttpUrl.Builder httpUrl = HttpUrl.parse(this.clientOptions.environment().getUrl())
                .newBuilder()
                .addPathSegments("api/connections")
        ...
        CompletableFuture<PolytomicHttpResponse<ConnectionProxySettingsEnvelope>> future = new CompletableFuture<>();
        client.newCall(okhttpRequest).enqueue(new Callback() {
            @Override
            public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
                try (ResponseBody responseBody = response.body()) {
                    ...
                    if (response.isSuccessful()) {
                        future.complete(new PolytomicHttpResponse<>(
                                ObjectMappers.JSON_MAPPER.readValue(
                                        responseBodyString, ConnectionProxySettingsEnvelope.class),
                                response));
                        return;
                    }
                    try {
     ...
     */
    public CompletableFuture<PolytomicHttpResponse<ConnectionProxySettingsEnvelope>> updateProxySettings(
