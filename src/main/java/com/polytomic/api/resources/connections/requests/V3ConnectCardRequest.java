...
@JsonDeserialize(
    builder = V3ConnectCardRequest.Builder.class
)
public final class V3ConnectCardRequest {
  ...
  private V3ConnectCardRequest(Optional<String> connection, String name,
      Optional<String> organizationId, String redirectUrl, Optional<String> type,
      Optional<List<String>> whitelist, Map<String, Object> additionalProperties) {
  ...
  private boolean equalTo(V3ConnectCardRequest other) {
    return connection.equals(other.connection) && name.equals(other.name) && organizationId.equals(other.organizationId) && redirectUrl.equals(other.redirectUrl) && type.equals(other.type) && whitelist.equals(other.whitelist);
  }

  @Override
  public int hashCode() {
    return Objects.hash(this.connection, this.name, this.organizationId, this.redirectUrl, this.type, this.whitelist);
  }
  ...
  public static final class Builder implements NameStage, RedirectUrlStage, _FinalStage {
    ...
    public V3ConnectCardRequest build() {
      return new V3ConnectCardRequest(connection, name, organizationId, redirectUrl, type, whitelist, additionalProperties);
    }
  }
}
