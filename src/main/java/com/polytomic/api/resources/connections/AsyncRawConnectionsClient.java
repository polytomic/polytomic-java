...
public class AsyncRawConnectionsClient {
     ...
     */
    public CompletableFuture<PolytomicHttpResponse<ConnectSessionResponseEnvelope>> getConnectSession() {
    ...
    public CompletableFuture<PolytomicHttpResponse<ConnectSessionResponseEnvelope>> getConnectSession(
        ...
        CompletableFuture<PolytomicHttpResponse<ConnectSessionResponseEnvelope>> future = new CompletableFuture<>();
        client.newCall(okhttpRequest).enqueue(new Callback() {
            @Override
            public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
                try (ResponseBody responseBody = response.body()) {
                    ...
                    if (response.isSuccessful()) {
                        future.complete(new PolytomicHttpResponse<>(
                                ObjectMappers.JSON_MAPPER.readValue(
                                        responseBodyString, ConnectSessionResponseEnvelope.class),
                                response));
                        return;
                    }
                    try {
     ...
     */
    public CompletableFuture<PolytomicHttpResponse<GetConnectionUsageEnvelope>> getUsage(String id) {
     ...
     * assume a fixed vocabulary across connection types.</p>
     */
    public CompletableFuture<PolytomicHttpResponse<GetConnectionUsageEnvelope>> getUsage(
            String id, RequestOptions requestOptions) {
        HttpUrl.Builder httpUrl = HttpUrl.parse(this.clientOptions.environment().getUrl())
                .newBuilder()
                .addPathSegments("api/connections")
        ...
        CompletableFuture<PolytomicHttpResponse<GetConnectionUsageEnvelope>> future = new CompletableFuture<>();
        client.newCall(okhttpRequest).enqueue(new Callback() {
            @Override
            public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
                try (ResponseBody responseBody = response.body()) {
                    ...
                    if (response.isSuccessful()) {
                        future.complete(new PolytomicHttpResponse<>(
                                ObjectMappers.JSON_MAPPER.readValue(
                                        responseBodyString, GetConnectionUsageEnvelope.class),
                                response));
                        return;
                    }
                    try {
