...
public class AsyncRawConnectionsClient {
    ...
    public CompletableFuture<PolytomicHttpResponse<JsonschemaSchema>> getConnectionTypeSchema(
        ...
        return getConnectionTypeSchema(
                id, ConnectionsGetConnectionTypeSchemaRequest.builder().build(), requestOptions);
    }
    ...
    public CompletableFuture<PolytomicHttpResponse<ConnectionParameterValuesResponseEnvelope>> getParameterValues(
            String id, RequestOptions requestOptions) {
        return getParameterValues(
                id, ConnectionsGetParameterValuesRequest.builder().build(), requestOptions);
    }
    ...
    public CompletableFuture<PolytomicHttpResponse<ConnectionListResponseEnvelope>> listSharedConnections(
        ...
        return listSharedConnections(
                parentConnectionId,
                ConnectionsListSharedConnectionsRequest.builder().build());
    }
    ...
    public CompletableFuture<PolytomicHttpResponse<ConnectionListResponseEnvelope>> listSharedConnections(
        ...
        return listSharedConnections(parentConnectionId, request, null);
    }
