...
public class AsyncSharedConnectionsClient {
    protected final ClientOptions clientOptions;

    private final AsyncRawSharedConnectionsClient rawClient;

    public AsyncSharedConnectionsClient(ClientOptions clientOptions) {
        this.clientOptions = clientOptions;
        this.rawClient = new AsyncRawSharedConnectionsClient(clientOptions);
    }

    /**
     * Get responses with HTTP metadata like headers
     */
    public AsyncRawSharedConnectionsClient withRawResponse() {
