...
public class RawConnectionsClient {
    ...
    public PolytomicHttpResponse<JsonschemaSchema> getConnectionTypeSchema(
     ...
     * Tests a connection configuration.
     */
    public PolytomicHttpResponse<Void> testConnection(TestConnectionRequest request, RequestOptions requestOptions) {
        HttpUrl.Builder httpUrl = HttpUrl.parse(this.clientOptions.environment().getUrl())
                .newBuilder()
    ...
    public PolytomicHttpResponse<ConnectionResponseEnvelope> get(String id, ConnectionsGetRequest request) {
        return get(id, request, null);
    }

    public PolytomicHttpResponse<ConnectionResponseEnvelope> get(
     ...
     * </blockquote>
     */
    public PolytomicHttpResponse<V2CreateSharedConnectionResponseEnvelope> createSharedConnection(
    ...
    public PolytomicHttpResponse<ConnectionListResponseEnvelope> listSharedConnections(String parentConnectionId) {
