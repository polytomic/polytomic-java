...
@JsonDeserialize(
    builder = V2CreateConnectionRequestSchema.Builder.class
)
public final class V2CreateConnectionRequestSchema {
  ...
  private V2CreateConnectionRequestSchema(Optional<Map<String, Object>> configuration, String name,
      Optional<String> organizationId, Optional<List<String>> policies,
      Optional<String> redirectUrl, String type, Optional<Boolean> validate,
  ...
  private boolean equalTo(V2CreateConnectionRequestSchema other) {
    return configuration.equals(other.configuration) && name.equals(other.name) && organizationId.equals(other.organizationId) && policies.equals(other.policies) && redirectUrl.equals(other.redirectUrl) && type.equals(other.type) && validate.equals(other.validate);
  }

  @Override
  public int hashCode() {
    return Objects.hash(this.configuration, this.name, this.organizationId, this.policies, this.redirectUrl, this.type, this.validate);
  }
  ...
  public static final class Builder implements NameStage, TypeStage, _FinalStage {
    ...
    public V2CreateConnectionRequestSchema build() {
      return new V2CreateConnectionRequestSchema(configuration, name, organizationId, policies, redirectUrl, type, validate, additionalProperties);
    }
  }
}
