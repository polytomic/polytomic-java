...
public class ConnectionsClient {
    ...
    public JsonschemaSchema getConnectionTypeSchema(String id, ConnectionsGetConnectionTypeSchemaRequest request) {
        return this.rawClient.getConnectionTypeSchema(id, request).body();
    }
    ...
    public ConnectionParameterValuesResponseEnvelope getParameterValues(
        ...
        return this.rawClient.getParameterValues(id, request).body();
    }

    public ConnectionParameterValuesResponseEnvelope getParameterValues(
            String id, ConnectionsGetParameterValuesRequest request, RequestOptions requestOptions) {
        return this.rawClient.getParameterValues(id, request, requestOptions).body();
    }
    ...
    public ConnectionListResponseEnvelope listSharedConnections(
        ...
        return this.rawClient.listSharedConnections(parentConnectionId, request).body();
    }
