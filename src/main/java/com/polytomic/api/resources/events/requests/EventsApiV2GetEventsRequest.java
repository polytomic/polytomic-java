...
@JsonDeserialize(
    builder = EventsApiV2GetEventsRequest.Builder.class
)
public final class EventsApiV2GetEventsRequest {
  ...
  private EventsApiV2GetEventsRequest(Optional<String> organizationId, Optional<String> type,
      Optional<OffsetDateTime> startingAfter, Optional<OffsetDateTime> endingBefore,
  ...
  private boolean equalTo(EventsApiV2GetEventsRequest other) {
    return organizationId.equals(other.organizationId) && type.equals(other.type) && startingAfter.equals(other.startingAfter) && endingBefore.equals(other.endingBefore) && limit.equals(other.limit);
  }
  ...
  public static final class Builder {
    ...
    public EventsApiV2GetEventsRequest build() {
      return new EventsApiV2GetEventsRequest(organizationId, type, startingAfter, endingBefore, limit, additionalProperties);
    }
  }
}
